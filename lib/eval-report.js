 ...
 *   promptB?: string,
 *   result: {
 *     conditions?: { metricId?: string | null, judgeModel?: string, runs?: number, caseCount?: number, maxConcurrency?: number, durationMs?: number },
...
export function buildEvalReportMarkdown(opts) {
  ...
  const lines = [
    ...
    ...(conditions.judgeModel
      ? [`| Judge model | ${escapeCell(conditions.judgeModel)} |`]
      : []),
